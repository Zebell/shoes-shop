          ...
          <div className='cart__body' ref={cartBodyRef} onClick={onCloseCart}>
            <div className={`cart__content ${classTransitions}`}>
              ...
              {cartItems.length > 0 ? 
                ...
                ? <CartInfo title='Your order is complete!' image=' /img/order-completed.jpg' text={`Your order #${orderNumber} will soon be transferred to the delivery service`} completed/> 
                : <CartInfo title='Cart is empty' image=' /img/cart-empty.png' text='Add at least one item to the order'/>}      
